    ...
    stages {
        stage('Git checkout') {
            steps {
                   ...
                   git 'https://github.com/gururajkotyal/staragile_project1.git'
        ...
        stage('Publish HTML') {
          ...
          stage('Docker build image') {
              steps {
                  ...
                  sh 'sudo docker build -t gururajdockerusername/bank-finance:${BUILD_NUMBER}.0 .'
        ...
        stage('Docker login and push') {
              steps {
                  ...
                  sh 'sudo docker push gururajdockerusername/bank-finance:${BUILD_NUMBER}.0 '
                  }
                }
